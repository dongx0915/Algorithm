# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/17.svg" class="solvedac-tier"> [광고](https://www.acmicpc.net/problem/1305) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|53742668|dongdong99|맞았습니다!! Upload|44628KB|276ms|Kotlin (JVM)|468B|
