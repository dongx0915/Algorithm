# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [홍익대학교](https://www.acmicpc.net/problem/16394) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|56965353|dongdong99|맞았습니다!! |17680KB|208ms|Java 11|176B|
