# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [세금](https://www.acmicpc.net/problem/20492) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|59686081|dongdong99|맞았습니다!! |12336KB|92ms|Kotlin (JVM)|121B|
