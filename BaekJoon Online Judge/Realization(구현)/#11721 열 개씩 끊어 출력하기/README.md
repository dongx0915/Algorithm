# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/3.svg" class="solvedac-tier"> [열 개씩 끊어 출력하기](https://www.acmicpc.net/problem/11721) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|55098231|dongdong99|맞았습니다!! |12400KB|96ms|Kotlin (JVM)|197B|
