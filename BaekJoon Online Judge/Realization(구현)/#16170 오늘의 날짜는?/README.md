# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [오늘의 날짜는?](https://www.acmicpc.net/problem/16170) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|58525992|dongdong99|맞았습니다!! |13568KB|116ms|Kotlin (JVM)|242B|
