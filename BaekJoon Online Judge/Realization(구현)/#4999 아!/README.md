# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [아!](https://www.acmicpc.net/problem/4999) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|56473775|dongdong99|맞았습니다!! |12320KB|96ms|Kotlin (JVM)|115B|
