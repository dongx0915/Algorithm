# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/9.svg" class="solvedac-tier"> [가장 긴 감소하는 부분 수열](https://www.acmicpc.net/problem/11722) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|55712622|dongdong99|맞았습니다!! |26860KB|240ms|Kotlin (JVM)|465B|
