# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/12.svg" class="solvedac-tier"> [스도쿠](https://www.acmicpc.net/problem/2580) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|56317218|dongdong99|맞았습니다!! |23976KB|712ms|Kotlin (JVM)|1840B|
