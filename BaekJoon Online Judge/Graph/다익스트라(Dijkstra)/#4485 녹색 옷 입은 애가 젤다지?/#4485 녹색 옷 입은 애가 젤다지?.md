# <img src="https://d2gd6pc034wcta.cloudfront.net/tier/12.svg" class="solvedac-tier" style="user-select: auto;" width="20px"> [녹색 옷 입은 애가 젤다지?](https://www.acmicpc.net/problem/4485)
...
<div class="col-md-12" style="user-select: auto;">
			<div class="table-responsive" style="user-select: auto;">
				...
				<td style="user-select: auto;">256 MB</td>
									<td style="user-select: auto;">8083</td>
					<td style="user-select: auto;">4213</td>
					<td style="user-select: auto;">2992</td>
					<td style="user-select: auto;">51.041%</td>
								</tr>
				</tbody>
				</table>
			</div>
...
0
					...
					<div class="col-md-6" style="user-select: auto;">
						...
						<pre class="sampledata" id="sample-output-1" style="user-select: auto;">Problem 1: 20
Problem 2: 19
Problem 3: 36
</pre>
						</section>
...
## 풀이
 - 2차원 배열의 각 칸까지의 최단 거리를 구하는 문제
 - 기존의 다익스트라가 특정 노드와 연결된 노드들에 대해 거리를 갱신해나가는 방식이었다면 해당 문제에선 특정 좌표에서 상,하,좌,우 네 방향의 원소에 대해 거리를 갱신해나가는 방식
