# <img src="https://d2gd6pc034wcta.cloudfront.net/tier/12.svg" class="solvedac-tier" style="user-select: auto;" width="20px"> [웜홀](https://www.acmicpc.net/problem/1865)
...
<div class="col-md-12" style="user-select: auto;">
			<div class="table-responsive" style="user-select: auto;">
				...
				<td style="user-select: auto;">128 MB</td>
									<td style="user-select: auto;">16436</td>
					<td style="user-select: auto;">3338</td>
					<td style="user-select: auto;">2018</td>
					<td style="user-select: auto;">22.718%</td>
								</tr>
				</tbody>
				</table>
			</div>
...
3 1 8
					...
					<div class="col-md-6" style="user-select: auto;">
						...
						<pre class="sampledata" id="sample-output-1" style="user-select: auto;">NO
YES
</pre>
						</section>
					</div>
...
## 문제점
 - 모든 경로에 대해서 시간을 측정해야하는데, bfs로는 경로 중복 체크를 할 수가 없어 무한 루프가 됨
