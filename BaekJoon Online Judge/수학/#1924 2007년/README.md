# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/5.svg" class="solvedac-tier"> [2007년](https://www.acmicpc.net/problem/1924) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|53925210|dongdong99|맞았습니다!! Upload|15328KB|148ms|Kotlin (JVM)|419B|
