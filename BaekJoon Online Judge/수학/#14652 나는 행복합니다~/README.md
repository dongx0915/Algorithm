# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [나는 행복합니다~](https://www.acmicpc.net/problem/14652) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|60113707|dongdong99|맞았습니다!! |20824KB|132ms|Kotlin (JVM)|99B|
