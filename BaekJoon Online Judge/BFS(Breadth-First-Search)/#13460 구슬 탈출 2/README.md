# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/15.svg" class="solvedac-tier"> [구슬 탈출 2](https://www.acmicpc.net/problem/13460) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|53986513|dongdong99|맞았습니다!! Upload|275824KB|1424ms|Kotlin (JVM)|4359B|
