# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/14.svg" class="solvedac-tier"> [벽 부수고 이동하기 4](https://www.acmicpc.net/problem/16946) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|55917059|dongdong99|맞았습니다!! |319504KB|1472ms|Kotlin (JVM)|2304B|
