# <img src="https://d2gd6pc034wcta.cloudfront.net/tier/10.svg" class="solvedac-tier" style="user-select: auto;" width="20px"> [케빈 베이컨의 6단계 법칙](https://www.acmicpc.net/problem/1389)
...
<div class="col-md-12" style="user-select: auto;">
			<div class="table-responsive" style="user-select: auto;">
				...
				<td style="user-select: auto;">128 MB</td>
									<td style="user-select: auto;">14207</td>
					<td style="user-select: auto;">7581</td>
					<td style="user-select: auto;">5903</td>
					<td style="user-select: auto;">54.241%</td>
								</tr>
				</tbody>
				</table>
			</div>
...
<div class="col-md-12" style="user-select: auto;">
				<div class="row" style="user-select: auto;">
					<div class="col-md-6" style="user-select: auto;">
						...
						<pre class="sampledata" id="sample-input-1" style="user-select: auto;">5 5
1 3
1 4
4 5
4 3
...
## 풀이
 - 한 사람이 다른 사람들과 이어질 때의 단계를 모두 합한게 케빈 베이컨의 수
 - 각각의 사람들에 대해 케빈 베이컨의 수를 모두 합한 값이 가장 작은 사람을 구하는 문제
 - 그래프로 표현해서 bfs 돌리면 간단하게 풀 수 있다.
