# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/15.svg" class="solvedac-tier"> [구슬 탈출 3](https://www.acmicpc.net/problem/15644) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|54040978|dongdong99|맞았습니다!! |462580KB|2200ms|Kotlin (JVM)|4711B|
