# <img src="https://d2gd6pc034wcta.cloudfront.net/tier/9.svg" class="solvedac-tier" width="20px"> [유기농 배추](https://www.acmicpc.net/problem/1012)
...
그리고 배추가 심어져 있는 위치의 개수 <b>K(1 ≤ K ≤ 2500)</b>이 주어진다. 그 다음 K줄에는 배추의 위치 **X(0 ≤ X ≤ M-1)**, **Y(0 ≤ Y ≤ N-1)**가 주어진다.
