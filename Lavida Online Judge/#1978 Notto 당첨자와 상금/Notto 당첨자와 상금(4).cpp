...
int main() {
	...
	while (test--) {
		...
		if (cnt_1st != 0) money_1st = (dev_money / 2) / cnt_1st;
		else money_1st = 0;
		if (cnt_2nd != 0) money_2nd = (dev_money / 4) / cnt_2nd;
		else money_2nd = 0;
		if (cnt_3rd != 0) money_3rd = ((dev_money / 100) * 15) / cnt_3rd;
		else money_3rd = 0;
		if (cnt_4th != 0) money_4th = ((dev_money / 100) * 5) / cnt_4th;
		else money_4th = 0;
