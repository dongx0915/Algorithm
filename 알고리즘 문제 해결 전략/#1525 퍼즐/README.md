# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/14.svg" class="solvedac-tier"> [퍼즐](https://www.acmicpc.net/problem/1525) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|54140142|dongdong99|맞았습니다!! |155176KB|956ms|Kotlin (JVM)|1930B|
