# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/1.svg" class="solvedac-tier"> [과제 안 내신 분..?](https://www.acmicpc.net/problem/5597) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|53343212|dongdong99|맞았습니다!! |13320KB|124ms|Kotlin (JVM)|207B|
